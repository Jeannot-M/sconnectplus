...
._section_offre .grid_offre ._card img {
    ...
    .home-slider-overlay {
        ...
        width: 100%;
        height: 100%;
        background: transparent; /* Overlay transparent - pas de couleur bleue */
        z-index: 2;
    }
    ...
    <section class="company-intro-panel" style="position: relative; overflow: hidden;">
        ...
        <div class="home-slider-container">
            <div class="home-slider">
                <div class="home-slide active" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6138.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6139.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6140.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6141.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6147.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6154.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6156.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6158.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6313.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6315.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6316.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6317.JPG') }}');"></div>
                <div class="home-slide" style="background-image: url('{{ asset('images/slides/slides_acceuil/acceuil/IMG_6318.JPG') }}');"></div>
            </div>
            <div class="home-slider-overlay"></div>
        </div>
        <!-- nos services -->
        <div class="intro-container" style="height: 65vh; display: flex; align-items: center; justify-content: center; position: relative; z-index: 2;">
            <div class="intro-content">
                <div class="intro-text" style="display: none;">
                    ...
                    <p class="intro-description">
                        {{ __("Nous sommes une entreprise innovante spécialisée dans les solutions informatiques et technologiques. Depuis 2022, nous accompagnons les entreprises, institutions et entrepreneurs congolais dans leur transformation digitale avec des solutions fiables, performantes et accessibles.") }}
                    </p>
            ...
            <div class="search-container">
                <form id="site-search-form" class="search-form">
                    <div class="search-input-wrapper">
                        <input type="text" id="site-search-input" class="search-input" placeholder="{{ __('Rechercher sur le site...') }}" autocomplete="off">
            ...
            <div class="tab_panel is-active">
                    <div class="grid_offre">
                        <a href="" onclick="return false;" class="_card">
                            ...
                            <img src="https://www.bouyguestelecom.fr/static/wbm/media/hub/farandole-meilleurs-smartphones.png" alt="" srcset="">
                        ...
                        <a  href="" onclick="return false;" class="_card">
                            ...
                            <a  href="" onclick="return false;" class="_card">
                                ...
                                <img src="https://www.bouyguestelecom.fr/static/wbm/media/hub/routeur-wifi-6.png" alt="" srcset="">
                            </a>
    
                    
                        <a href="" onclick="return false;" class="_card">
                            <h3>M'offrir un Smart TV</h3>
                            <img src="https://www.bouyguestelecom.fr/static/wbm/media/hub/samsung-smart-tv.png" alt="" srcset="">
                        </a>
                    </div>
            </div>
            ...
            <div class="tab_panel">
                {{-- <div class="grid_offre">
                    ...
                    <div class="_card">
                        ...
                        <img src="https://www.bouyguestelecom.fr/static/wbm/media/hub/mobiles-et-carte-sim.png" alt="" srcset="">
                    </div>
        ...
        <div class="fordiv _container">
            <div class="_card4">
                ...
                <div class="_titleCard">
                    ...
                    <p>{{ __("Parce que nous pensons que chacun, quel que soit l'endroit où il se trouve, devrait pouvoir accéder à l'internet à haut débit et de bonne qualité.") }}</p>
                </div>
            </div>
            <div class="_card4">
                ...
                <div class="_titleCard">
                    ...
                    <p>{{ __("Dès aujourd'hui, rejoignez la communauté des entreprises déjà connectées à Sconnect Plus...") }}</p>
                   <p>
                    {{ __("Des millions de personnes vivant dans des zones urbaines et rurales au congo, peuvent désormais accéder à l'internet haut débit.") }}
                   </p>
                </div> 
            </div>
    ...
    <section class="modern-services-section" id="nos-services">
        <div class="services-container">
            ...
            <div class="service-card featured">
                    <div class="service-icon">
                        <img src="{{ asset('images/svg/robot.jpg') }}" class="w-5" style="width: 45px;" alt="" srcset="">
                    </div>
                    <h3>{{ __("Sconnect Tech4School") }}</h3>
                    <p>{{ __("Tech4School « Technology for School » est un programme after-school du Groupe Sconnect Plus, dédié à l’intégration des activités de la robotique et de la réalité virtuelle (VR/AR) au sein des établissements scolaires.
                        Notre programme initie les élèves à la technologie, renforce leurs compétences STEM (sciences, technologies, ingénierie et mathématiques), et fait de l’école un véritable laboratoire d’innovation où les jeunes apprennent à penser, créer et résoudre les défis d’aujourd’hui et de demain.") }}</p>
                ...
                <div class="service-card featured">
                    ...
                    <p>{{ __("Connexion haut débit pour entreprises et institutions avec solutions adaptées à vos besoins spécifiques.") }}</p>
                    <div class="service-features">
                ...
                <div class="service-card featured">
                    ...
                    <p>{{ __("Mentorat, incubation et coaching personnalisé pour accompagner le développement de votre entreprise.") }}</p>
                    <div class="service-features">
                ...
                <div class="service-card featured">
                    ...
                    <p>{{ __("Installation et configuration de systèmes de téléphonie IP pour optimiser les communications de votre entreprise.") }}</p>
                    <div class="service-features">
                ...
                <div class="service-card featured">
                    ...
                    <p>{{ __("Câblage, Wi-Fi et sécurité réseau pour créer une infrastructure informatique robuste et sécurisée.") }}</p>
                    <div class="service-features">
                ...
                <div class="service-card featured">
                    ...
                    <p>{{ __("Maintenance, inventaire et assistance technique pour optimiser la performance de votre parc informatique.") }}</p>
                    <div class="service-features">
                ...
                <div class="service-card featured">
                    <div class="service-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <path d="M5.6 5.6c.39.39 1.02.39 1.41 0s.39-1.02 0-1.41-.39-1.02-1.41 0-1.02.39-1.02 1.41.39 1.02 1.02 1.02z"></path>
                            <path d="M18.4 18.4c.39.39 1.02.39 1.41 0s.39-1.02 0-1.41-.39-1.02-1.41 0-1.02.39-1.02 1.41.39 1.02 1.02 1.02z"></path>
                            <path d="M5.6 18.4c-.39.39-.39 1.02 0 1.41s1.02.39 1.41 0 .39-1.02 0-1.41-1.02-.39-1.41 0z"></path>
                            <path d="M18.4 5.6c-.39.39-.39 1.02 0 1.41s1.02.39 1.41 0 .39-1.02 0-1.41-1.02-.39-1.41 0z"></path>
                        </svg>
                    </div>
                    <h3>{{ __("Sécurisation des données d'entreprise") }}</h3>
                    <p>{{ __("Sauvegarde, chiffrement et audit de sécurité pour protéger efficacement vos données sensibles.") }}</p>
                    <div class="service-features">
            ...
            <section class="news-section">
                ...
                <div class="news-slider">
                    <div class="news-track">
                        <!-- Original Set -->
                        <div class="news-card"><img src="{{ asset('images/actualite/IMG_8291.JPG') }}" alt="Actualité Sconnect"></div>
                        <div class="news-card"><img src="{{ asset('images/actualite/IMG_5996.JPG') }}" alt="Actualité Sconnect"></div>
                        <div class="news-card"><img src="{{ asset('images/actualite/IMG_5997.JPG') }}" alt="Actualité Sconnect"></div>
                        <div class="news-card"><img src="{{ asset('images/actualite/IMG_7484.JPG') }}" alt="Actualité Sconnect"></div>
                        <div class="news-card"><img src="{{ asset('images/actualite/IMG_7489.JPG') }}" alt="Actualité Sconnect"></div>
                        <div class="news-card"><img src="{{ asset('images/actualite/IMG_8288.JPG') }}" alt="Actualité Sconnect"></div>
                        <div class="news-card"><img src="{{ asset('images/actualite/IMG_8299.JPG') }}" alt="Actualité Sconnect"></div>
                        <div class="news-card"><img src="{{ asset('images/actualite/IMG_8302.JPG') }}" alt="Actualité Sconnect"></div>
        ...
        <div class="stats-container">
            ...
            <div class="stats-grid">
                ...
                <div class="stat-item" data-target="253">
                    <div class="stat-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            ...
                            <path d="M8.21 13.89-1.05 2.9a2 2 0 0 0 2.39 2.7l2.45-.67 2.44.67a2 2 0 0 0 2.39-2.7l-1.04-2.9"></path>
                        </svg>
                    </div>
                    <div class="stat-content">
                        <div class="stat-header">
                ...
                <div class="stat-item" data-target="12">
                    <div class="stat-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                            <path d="M9.663 17h4.673M12 12v5m-6.364-1C4.648 14.678 4 13.38 4 12c0-3.75 4-8 8-8s8 4.25 8 8c0 1.381-.649 2.678-1.636 4"></path>
                ...
                <div class="about-video-container">
                    <div class="image-container video-container">
                        <div class="responsive-video-wrapper">
                            <iframe src="https://www.youtube.com/embed/xUPD_xI9tjI" title="Sconnect Plus RDC PRÉSENTATION DES SERVICES" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen style="
...
"></iframe>
    ...
    <section class="testimonials-section" id="temoignages">
        <div class="testimonials-container">
            <div class="section-header text-center">
                <span class="section-tag" style="color: #00AAE4; font-weight: 800; text-transform: uppercase; font-size: 11px; letter-spacing: 2px; display: block; margin-bottom: 10px;">{{ __("Témoignages de nos Partenaires") }}</span>
            ...
            <div class="testimonials-slider">
                <div class="testimonials-track">
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-quote">« Grâce à Sconnect Plus, notre réseau informatique est enfin sécurisé. Leur équipe a su nous accompagner avec professionnalisme. Aujourd’hui, on travaille sereinement mieux qu’avant. »</p>
                    ...
                    <div class="testimonial-card">
                        <div class="testimonial-stars">
                            <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star" style="color: #e0e0e0;"></i>
                        </div>
                        <p class="testimonial-quote">« On leur a confié l’installation de l’une de nos stations relais, dans une zone difficile. Résultat : une connexion stable, rapide, et une vraie tranquillité côté technique. Merci à l’entreprise Sconnect Plus… »</p>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-quote">« L’application mobile développée par Sconnect Plus nous a changé la vie. On gère mieux nos opérations, nos équipes, et nos clients sont plus satisfaits. Nous sommes reconnaissants et nous espérons collaborer d’avantage avec Sconnect Plus. »</p>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-quote">« Leur programme de formation IT est concret, pratique, à jour et bien structuré. Nos agents viennent de terminer une formation chez Sconnect Plus et ça se ressent dans leur travail quotidien. Nous disons Merci à Sconnect Plus. »</p>
                        <div class="testimonial-author">
                    ...
                    <div class="testimonial-card">
                        ...
                        <p class="testimonial-quote">« Nous avons pu digitaliser toute notre structure grâce à leurs solutions simples, efficaces et bien pensées. On sent que c’est du sur-mesure. Au début j’avais des doutes car ils ne font pas assez de publicités mais à la fin on a tous compris qu’il fallait vraiment leur faire confiance, ce sont des experts. Merci Sconnect Plus… »</p>
                        <div class="testimonial-author">
...
<section class="newsletter-section">
    <div class="container" style="text-align: center;">
        ...
        <div class="alert-success" style="position: fixed; top: 20px; right: 20px; z-index: 9999; background: #4CAF50; color: white; padding: 15px 25px; border-radius: 4px; box-shadow: 0 4px 6px rgba(0,0,0,0.1); display: flex; align-items: center; justify-content: space-between; max-width: 400px;">
    ...
    <script src="{{ asset('js/service-slideshow.js') }}?v=1.1"></script>
    <!-- Script pour le slider automatique de la page d'accueil -->
    <script src="{{ asset('js/home-slider.js') }}?v=1.1"></script>
            ...
            document.addEventListener( 'DOMContentLoaded', function () 
                {
                    ...
                    if (devisButton) {
                        devisButton.addEventListener('click', function() {
                            // Scroll vers la section contact ou ouvrir un modal
                    ...
                    // L'animation des statistiques est maintenant gérée par stats-animation.js

                    // Carrousel de services dans le panneau d'introduction
                    ...
                    if (servicesSlideshow) {
                        ...
                        indicators.forEach((indicator, index) => {
                            indicator.addEventListener('click', () => {
                                ...
                                showSlide(currentSlide);
                                stopSlideshow();
                                startSlideshow(); // Redémarrer le timer
                            });
                        });
        ...
        {{-- Bouton flottant de demande de devis --}}
        @include('includes._floating-quote-btn')
        
        @include('includes._chatbot')
        
        {{-- Script pour l'accordéon du footer sur mobile --}}
        <script src="{{ asset('js/footer-accordion.js') }}"></script>
        
        {{-- Script pour le menu mobile --}}
        <script src="{{ asset('js/modern-header.js') }}"></script>
        
        {{-- Script pour la recherche sur le site --}}
        <script src="{{ asset('js/site-search.js') }}?v=1.1"></script>
